...
Hexbook is a free, vulnerable test site that is an online storefront built with the same
technologies used in today’s rich client and mobile applications. Hexbook has an AJAX
...
Hexbook enables users to configure each area of the application in order to change the
...
security testing tools and techniques to discover all the vulnerabilities. Hexbook also
...
======================
* [Wiki](https://github.com/rapid7/hexbookk/wiki)
* CyberSecology Blog: [Hexbook Test Site Review](http://cybersecology.com/hexbookk-review/)
